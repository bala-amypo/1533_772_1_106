...
public class ComplianceLog {
    ...
    @Column(name = "sensor_reading_id", nullable = false, unique = true)
    ...
    public ComplianceLog(Long sensorReadingId, Long thresholdId,
                         String statusAssigned, String remarks,
